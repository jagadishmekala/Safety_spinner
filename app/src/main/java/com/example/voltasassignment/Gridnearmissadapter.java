...
public class Gridnearmissadapter extends BaseAdapter {
    private Context context;
    private List<ObservationAttachmentModel> attachment;

    public Gridnearmissadapter(Context context, List<ObservationAttachmentModel> attachment) {
    ...
    private void showImagePopup(final String imageUrl, View anchorView) {
        ...
        closeButton.setBackgroundResource(R.drawable.baseline_close_24); // Set text color
